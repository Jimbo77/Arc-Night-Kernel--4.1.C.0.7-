...
{ 0, 24576,SRC_LPXO, 0, 0, 30720000, 900, VDD_RAW(875) },
{ 0, 61440, PLL_3, 5, 11, 61440000, 900, VDD_RAW(875) },
{ 1, 122880, PLL_3, 5, 5, 61440000, 900, VDD_RAW(875) },
{ 2, 184320, PLL_3, 5, 4, 61440000, 900, VDD_RAW(875) },
{ 1, 245760, PLL_3, 5, 2, 61440000, 900, VDD_RAW(875) },
{ 0, 368640, PLL_3, 5, 1, 122800000, 900, VDD_RAW(875) },
{ 1, 460800, PLL_1, 2, 0, 153600000, 950, VDD_RAW(925) },
{ 0, 576000, PLL_1, 2, 0, 153600000, 1000, VDD_RAW(975) },
{ 0, 652800, PLL_1, 2, 0, 153600000, 1050, VDD_RAW(1025) },
{ 1, 768000, PLL_1, 2, 0, 153600000, 1050, VDD_RAW(1025) },
{ 1, 806400, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1075), &pll2_tbl[0]},
{ 1, 921600, PLL_2, 3, 0, UINT_MAX, 1150, VDD_RAW(1125), &pll2_tbl[1]},
{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1175), &pll2_tbl[2]},
{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1175), &pll2_tbl[3]},
{ 1, 1200000, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1175), &pll2_tbl[4]},
{ 1, 1305600, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1225), &pll2_tbl[5]},
{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1225), &pll2_tbl[6]},
{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1275), &pll2_tbl[7]},
{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1350, VDD_RAW(1325), &pll2_tbl[8]},
{ 1, 1708800, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1375), &pll2_tbl[9]},
{ 1, 1804800, PLL_2, 3, 0, UINT_MAX, 1450, VDD_RAW(1425), &pll2_tbl[10]},
{ 0, 1900800, PLL_2, 3, 0, UINT_MAX, 1500, VDD_RAW(1475), &pll2_tbl[11]},
{ 0 }
};
